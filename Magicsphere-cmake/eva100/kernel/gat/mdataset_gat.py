...
class MGCN_dataset_m32_gat(torch.nn.Module):
    
    def __init__(self):
        super(MGCN_dataset_m32_gat, self).__init__()
    
    def m_block_8_16_mr(self, data, dimN): 
        self.graph = np.load('./dgl_dataset/block/' + data +'-tf32-8-16-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_8_16_r(self, data, dimN): 
        self.graph = np.load('./dgl_dataset/block/' + data +'-tf32-8-16-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_16_8_r(self, data, dimN): 
        self.graph = np.load('./dgl_dataset/block/' + data +'-tf32-16-8-r.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
    ...
    def m_block_16_8_mr(self, data, dimN): 
        self.graph = np.load('./dgl_dataset/block/' + data +'-tf32-16-8-mr.npz')
        self.num_nodes_ori = self.graph['num_nodes_ori']-0
        self.num_nodes = self.graph['num_nodes']-0
        self.num_edges = self.graph['num_edges']-0
...
class MGCN_dataset_m16_gat(torch.nn.Module):
    
    def __init__(self):
        super(MGCN_dataset_m16_gat, self).__init__()
