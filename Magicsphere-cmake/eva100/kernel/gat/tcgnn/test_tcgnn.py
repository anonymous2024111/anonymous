...
def kernel(inputInfo, epoches):
    X_prime, spmm_ms_avg = TCGNN_kernel.forward_ef(inputInfo.x, inputInfo.row_pointers, inputInfo.column_index, inputInfo.blockPartition, inputInfo.edgeToColumn, inputInfo.edgeToRow, epoches)
